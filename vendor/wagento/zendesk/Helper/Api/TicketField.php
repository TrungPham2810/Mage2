...
class TicketField extends AbstractApi
{
    ...
    public const CREATE_TICKET_FIELD = '/api/v2/ticket_fields.json';

    // List Ticket Fields: GET /api/v2/ticket_fields.json
    public const LIST_TICKET_FIELDS = '/api/v2/ticket_fields.json';

    // Show Ticket Field: GET /api/v2/ticket_fields/{id}.json
    public const SHOW_TICKET_FIELD = '/api/v2/ticket_fields/%s.json';
